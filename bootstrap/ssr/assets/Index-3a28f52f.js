...
import _sfc_main$7 from "./CustomersTable-0e7555db.js";
...
import "./CustomersForm-0e3f1d5d.js";
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_sfc_main$5, {
                          onClick: () => unref(eventBus).$emit("openModal", "customer::create"),
                          color: "info",
                          icon: unref(mdiPlus),
                          label: "Add",
                          small: ""
