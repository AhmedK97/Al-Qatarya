...
import { mdiFileDocumentMultipleOutline, mdiDomain, mdiPlus, mdiExport } from "@mdi/js";
import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3 } from "./LayoutAuthenticated-dae51493.js";
import _sfc_main$7 from "./ProjectsTable-0e83e825.js";
...
import "./ProjectsForm-f0670327.js";
...
import "vue-select";
import "./ProjectsUploadMediaForm-dff4a487.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "List Projects" }, null, _parent2, _scopeId));
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_sfc_main$5, {
                          onClick: () => unref(eventBus).$emit("openModal", "project::create"),
                          color: "info",
                          icon: unref(mdiPlus),
                          label: "Add",
                          small: ""
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode(_sfc_main$7, {
                            ...
                            employees: __props.employees,
                            services: __props.services
                          }, null, 8, ["filters", "projects", "customers", "employees", "services"])
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(unref(Head), { title: "List Projects" }),
