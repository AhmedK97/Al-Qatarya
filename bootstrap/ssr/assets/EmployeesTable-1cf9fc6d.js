...
import _sfc_main$2 from "./EmployeesForm-9ee675aa.js";
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      eventBus.$on("closeModal", (modalToClose) => {
        if (modalToClose === "employee::create" || modalToClose === "employee::update") {
    ...
    const formModalTitle = computed(() => {
      var _a2, _b2;
      return ((_a2 = currentlyEditedEmployee.value) == null ? void 0 : _a2.id) ? `Edit ${(_b2 = currentlyEditedEmployee.value) == null ? void 0 : _b2.name} Employee` : "Add New Employee";
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, { employee: currentlyEditedEmployee.value }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$2, { employee: currentlyEditedEmployee.value }, null, 8, ["employee"])
            ];
          }
        }),
        _: 1
      ...
      if (__props.employees.data.length === 0) {
      ...
      _push(`<!--[-->`);
      ssrRenderList(__props.employees.data, (employee) => {
        _push(`<tr><td data-label="ID">${ssrInterpolate(employee.id)}</td><td data-label="Name">${ssrInterpolate(employee.name)}</td><td data-label="Phone">${ssrInterpolate(employee.phone)}</td><td data-label="Status">${ssrInterpolate(employee.status)}</td><td data-label="Address">${ssrInterpolate(employee.address)}</td><td data-label="About">${ssrInterpolate(employee.about)}</td><td data-label="Created At">${ssrInterpolate(employee.created_at)}</td><td data-label="Action" class="before:hidden lg:w-1 whitespace-nowrap">`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$4, {
                ...
                small: "",
                onClick: ($event) => editEmployee(employee)
      ...
      _push(`<!--]--></tbody></table>`);
      if ((_b2 = (_a2 = __props.employees) == null ? void 0 : _a2.data) == null ? void 0 : _b2.length) {
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$3, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<!--[-->`);
                    ssrRenderList(__props.employees.links, (page, index) => {
                    ...
                    return [
                      (openBlock(true), createBlock(Fragment, null, renderList(__props.employees.links, (page, index) => {
              ...
              _push2(`<small${_scopeId}>Page ${ssrInterpolate(__props.employees.current_page)} of ${ssrInterpolate(__props.employees.total)}</small>`);
            } else {
              return [
                ...
                createVNode("small", null, "Page " + toDisplayString(__props.employees.current_page) + " of " + toDisplayString(__props.employees.total), 1)
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Employee/EmployeesTable.vue");
