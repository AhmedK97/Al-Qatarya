import { onMounted, reactive, watch, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, createTextVNode, useSSRContext } from "vue";
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(form).services, (service, id) => {
              ...
              if (unref(form) && unref(form).errors) {
                _push2(`<div${_scopeId}>`);
                if ((_a2 = unref(form)) == null ? void 0 : _a2.errors["services." + id + ".price"]) {
                  _push2(`<span class="block text-sm text-red-600"${_scopeId}>${ssrInterpolate((_b = unref(form)) == null ? void 0 : _b.errors["services." + id + ".price"])}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if ((_c = unref(form)) == null ? void 0 : _c.errors["services." + id + ".quantity"]) {
                  _push2(`<span class="block text-sm text-red-600"${_scopeId}>${ssrInterpolate((_d = unref(form)) == null ? void 0 : _d.errors["services." + id + ".quantity"])}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              (openBlock(true), createBlock(Fragment, null, renderList(unref(form).services, (service, id) => {
                ...
                return openBlock(), createBlock("div", {
                  ...
                  unref(form) && unref(form).errors ? (openBlock(), createBlock("div", { key: 0 }, [
                    ((_a2 = unref(form)) == null ? void 0 : _a2.errors["services." + id + ".price"]) ? (openBlock(), createBlock("span", {
                      key: 0,
                      class: "block text-sm text-red-600"
                    }, toDisplayString((_b = unref(form)) == null ? void 0 : _b.errors["services." + id + ".price"]), 1)) : createCommentVNode("", true),
                    ((_c = unref(form)) == null ? void 0 : _c.errors["services." + id + ".quantity"]) ? (openBlock(), createBlock("span", {
                      key: 1,
                      class: "block text-sm text-red-600"
                    }, toDisplayString((_d = unref(form)) == null ? void 0 : _d.errors["services." + id + ".quantity"]), 1)) : createCommentVNode("", true)
