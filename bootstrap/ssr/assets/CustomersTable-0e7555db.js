...
import _sfc_main$2 from "./CustomersForm-0e3f1d5d.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<table><thead><tr><th>#</th><th>Name</th><th>Phone</th><th>Address</th><th>About</th><th>Created At</th><th>Action</th></tr></thead><tbody><tr><td></td><td data-label="Filter Name"><input placeholder="Filter by name"${ssrRenderAttr("value", activeFilters.filteredBy.name)} class="w-full h-8 px-2 py-1 border rounded border-primary-100"></td><td data-label="Filter Phone"><input placeholder="Filter by Phone"${ssrRenderAttr("value", activeFilters.filteredBy.phone)} class="w-full h-8 px-2 py-1 border rounded border-primary-100"></td><td></td><td></td><td></td><td></td></tr>`);
