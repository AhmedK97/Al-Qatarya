        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (isUpdate.value) {
              ...
              _push2(ssrRenderComponent(_sfc_main$4, null, null, _parent2, _scopeId));
              _push2(`<label class="block mb-2 font-bold"${_scopeId}> Full price </label>`);
              _push2(ssrRenderComponent(_sfc_main$5, {
                errorMessage: unref(form).errors.full_price,
                modelValue: unref(form).full_price,
                "onUpdate:modelValue": ($event) => unref(form).full_price = $event
              }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_sfc_main$4, null, null, _parent2, _scopeId));
            ...
            return [
              ...
              isUpdate.value ? (openBlock(), createBlock("div", { key: 1 }, [
                ...
                createVNode(_sfc_main$4),
                createVNode("label", { class: "block mb-2 font-bold" }, " Full price "),
                createVNode(_sfc_main$5, {
                  errorMessage: unref(form).errors.full_price,
                  modelValue: unref(form).full_price,
                  "onUpdate:modelValue": ($event) => unref(form).full_price = $event
