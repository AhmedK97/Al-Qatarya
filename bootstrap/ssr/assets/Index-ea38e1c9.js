...
import { mdiBriefcase, mdiDomain, mdiPlus } from "@mdi/js";
import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3 } from "./LayoutAuthenticated-dae51493.js";
import _sfc_main$7 from "./ServicesTable-775aec4d.js";
...
import "./ServicesForm-cfaf65a0.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "List Services" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$2, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    icon: unref(mdiBriefcase),
                    number: __props.servicesCountQatarya,
                    label: "Qatarya Services",
                    color: "text-blue-500"
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    icon: unref(mdiBriefcase),
                    number: __props.servicesCountOthman,
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_sfc_main$5, {
                          onClick: () => unref(eventBus).$emit("openModal", "service::create"),
                          color: "info",
                          icon: unref(mdiPlus),
                          label: "Add",
                          small: ""
            ...
            return [
              createVNode(unref(Head), { title: "List Services" }),
