...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div></div></div><div class="flex flex-col space-y-4"><p class="text-2xl font-bold text-rose-900">${ssrInterpolate(_ctx.$t("footer.address"))}</p><div class="relative"><hr class="h-0.5 border-0 rounded-full bg-gray-900 opacity-10"><hr class="absolute top-0 w-10 h-1 border-0 rounded-full -translate-y-1/3 bg-rose-900"></div><div class="flex flex-col space-y-4"><div class="flex space-x-4 rtl:space-x-reverse"><img src="storage/images/location.svg" alt=""><p class="font-medium leading-relaxed text-gray-900 text-md">${ssrInterpolate(_ctx.$t("footer.address-text"))}</p></div><div class="flex space-x-4 rtl:space-x-reverse"><img src="storage/images/phone-footer.svg" alt=""><p class="font-medium leading-relaxed text-gray-900 text-md">${ssrInterpolate(_ctx.$t("footer.address-text1"))}</p></div><div class="flex space-x-4 rtl:space-x-reverse"><img src="storage/images/mail-footer.svg" alt=""><p class="font-medium leading-relaxed text-gray-900 text-md">${ssrInterpolate(_ctx.$t("footer.address-text2"))}</p></div></div></div><div class="flex flex-col mt-4 lg:mt-0"><div class="space-y-4"><p class="text-2xl font-bold text-rose-900">${ssrInterpolate(_ctx.$t("footer.support"))}</p><div class="relative"><hr class="h-0.5 border-0 rounded-full bg-gray-900 opacity-10"><hr class="absolute top-0 w-10 h-1 border-0 rounded-full -translate-y-1/3 bg-rose-900"></div><p class="font-medium leading-relaxed text-gray-900 text-md">${ssrInterpolate(_ctx.$t("footer.support-text"))}</p></div></div></div><div class="fixed z-50 hidden sm:block rtl:space-y-4 bottom-4 left-6 rtl:right-6 rtl:left-auto"><div class="w-16 h-16 bg-white rounded-full shadow-lg"><a href="tel:01000000000" class="flex items-center justify-center w-full h-full">`);
      _push(ssrRenderComponent(_component_dotlottie_player, {
...
const NavBar_vue_vue_type_style_index_0_scoped_f0e467b4_lang = "";
const _sfc_main = {
  __name: "NavBar",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "inset-0 z-50" }, _attrs))} data-v-f0e467b4><div class="bg-secondary-900" data-v-f0e467b4><div class="container flex justify-between max-w-6xl px-5 py-3 mx-auto" data-v-f0e467b4><div class="flex items-center space-x-2 rtl:space-x-reverse" data-v-f0e467b4><img src="/storage/images/house.svg" class="w-5 h-7" alt="" data-v-f0e467b4><p class="pr-4 mt-1 text-xs font-normal text-gray-900 rtl:pr-0 rtl:pl-4 ltr:mt-2 sm:text-base" data-v-f0e467b4>${ssrInterpolate(_ctx.$t("home.top.nav"))}</p></div><div class="flex items-center space-x-16 rtl:space-x-reverse" data-v-f0e467b4><div class="flex items-center space-x-2 rtl:flex-row rtl:space-x-reverse" data-v-f0e467b4><img src="/storage/images/globe.svg" alt="" data-v-f0e467b4><ul class="mt-1" data-v-f0e467b4><!--[-->`);
      ssrRenderList(_ctx.$page.props.locale, (local) => {
        _push(`<li data-v-f0e467b4>`);
        if (local.currentLocaleCode !== local.code) {
          _push(`<a rel="alternate" class="text-sm font-medium text-gray-900"${ssrRenderAttr("hreflang", local.code)}${ssrRenderAttr("href", local.url)} data-v-f0e467b4>${ssrInterpolate(local.name)}</a>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</li>`);
      });
      _push(`<!--]--></ul></div><div class="hidden space-x-6 sm:flex rtl:space-x-reverse" data-v-f0e467b4><a href="#" data-v-f0e467b4><img src="/storage/images/facebook-upper.svg" class="w-4 h-4" alt="" data-v-f0e467b4></a><a href="#" data-v-f0e467b4><img src="/storage/images/instagram-upper.svg" class="w-4 h-4" alt="" data-v-f0e467b4></a><a href="#" data-v-f0e467b4><img src="/storage/images/twitter-upper.svg" class="w-4 h-4" alt="" data-v-f0e467b4></a></div></div></div></div><nav class="relative py-3 md:h-40 bg-rose-900" data-v-f0e467b4><div class="max-w-6xl px-4 mx-auto md:px-6 lg:px-8 md:mt-8" data-v-f0e467b4><div class="flex justify-between" data-v-f0e467b4><div class="flex" data-v-f0e467b4><div class="flex items-center shrink-0" data-v-f0e467b4>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("home")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`</div><div class="flex" data-v-f0e467b4><div class="flex items-center md:hidden" data-v-f0e467b4><button aria-label="Menu" class="inline-flex items-center justify-center p-2 text-white transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500" data-v-f0e467b4><svg class="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" data-v-f0e467b4><path class="${ssrRenderClass({
        hidden: showingNavigationDropdown.value,
        "inline-flex": !showingNavigationDropdown.value
      })}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-f0e467b4></path><path class="${ssrRenderClass({
        hidden: !showingNavigationDropdown.value,
        "inline-flex": showingNavigationDropdown.value
      })}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-f0e467b4></path></svg></button></div></div><div class="hidden md:space-x-12 lg:space-x-20 md:flex rtl:space-x-reverse" data-v-f0e467b4><div class="flex items-center space-x-4 rtl:space-x-reverse" data-v-f0e467b4><img src="/storage/images/phone-circle.svg" class="w-12" alt="" data-v-f0e467b4><div class="space-y-1" data-v-f0e467b4><p class="text-sm font-medium text-gray-300" data-v-f0e467b4>${ssrInterpolate(_ctx.$t("home.phone_number"))}</p><p class="font-medium text-md text-gray-50" data-v-f0e467b4> 0123456789 </p></div></div><div class="flex items-center space-x-4 rtl:space-x-reverse" data-v-f0e467b4><img src="/storage/images/email-circle.svg" class="w-12" alt="" data-v-f0e467b4><div class="space-y-1" data-v-f0e467b4><p class="text-sm font-medium text-gray-300" data-v-f0e467b4>${ssrInterpolate(_ctx.$t("home.email"))}</p><p class="font-medium text-md text-gray-50" data-v-f0e467b4> info@alqatarya.com </p></div></div></div></div><div class="flex items-center justify-center mt-4 space-x-20 sm:hidden rtl:space-x-reverse" data-v-f0e467b4><a href="#" data-v-f0e467b4><img src="/storage/images/facebook-mobile.svg" class="w-5 h-5 icon rotate" alt="" data-v-f0e467b4></a><a href="#" data-v-f0e467b4><img src="/storage/images/instagram-mobile.svg" class="w-5 h-5 icon rotate" alt="" data-v-f0e467b4></a><a href="#" data-v-f0e467b4><img src="/storage/images/twitter-mobile.svg" class="w-5 h-5 icon rotate" alt="" data-v-f0e467b4></a></div><div class="flex justify-center" data-v-f0e467b4><div class="absolute bottom-0 hidden px-2 py-1.5 translate-y-1/2 rounded-full space-x-20 lg:space-x-80 md:flex md:items-center md:justify-between z-50 bg-secondary-900 rtl:space-x-reverse" data-v-f0e467b4><div data-v-f0e467b4><div class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-900 transition duration-150 ease-in-out" data-v-f0e467b4>`);
      _push(ssrRenderComponent(_sfc_main$4, {
        ...
        trigger: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="" data-v-f0e467b4${_scopeId}><button type="button" class="inline-flex px-3 text-sm font-medium text-black transition duration-150 ease-in-out rounded-md focus:outline-none" data-v-f0e467b4${_scopeId}>${ssrInterpolate(_ctx.$t("home.services"))} <img class="w-4 h-4 mx-2 mt-[1.5px]" loading="lazy" src="/storage/images/down-arrow.svg" alt="arrow-down" data-v-f0e467b4${_scopeId}></button></span>`);
          } else {
            return [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-f0e467b4${_scopeId}><!--[-->`);
            ssrRenderList(_ctx.$page.props.services, (service) => {
              _push2(`<div class="py-4 ltr:pl-6 rtl:pr-6 hover:bg-secondary-700" data-v-f0e467b4${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p class="w-full" data-v-f0e467b4${_scopeId2}>${ssrInterpolate(service.name)}</p>`);
                  } else {
                    return [
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-5 py-2 text-white rounded-full bg-rose-900 hover:bg-rose-800" data-v-f0e467b4${_scopeId}>${ssrInterpolate(_ctx.$t("home.call_us"))}</div>`);
          } else {
            return [
      ...
      }, "w-full sm:w-[22rem] h-[35rem] absolute top-[7.8rem] bg-secondary-900 left-0 rtl:right-0 z-50 rounded-tr-2xl rounded-br-2xl rtl:rounded-tr-none rtl:rounded-br-none rtl:rounded-tl-2xl rtl:rounded-bl-2xl"])}" data-v-f0e467b4><div class="px-4 pt-4 overflow-hidden font-semibold text-gray-900 text-md" data-v-f0e467b4><div class="flex items-center p-5" data-v-f0e467b4><div data-v-f0e467b4><div class="" data-v-f0e467b4>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("about"),
        class: "text-right",
        active: _ctx.route().current("about")
      ...
      _push(`</div></div></div><div data-v-f0e467b4><div class="flex items-center p-5 space-x-4 transition duration-150 ease-in-out rtl:space-x-reverse" data-v-f0e467b4><div class="" data-v-f0e467b4>${ssrInterpolate(_ctx.$t("home.services"))}</div><img src="/storage/images/down-arrow-faq-white.svg" alt="" data-v-f0e467b4></div><div style="${ssrRenderStyle(serviceDropdown.value ? null : { display: "none" })}" class="transition duration-150 ease-in-out ltr:ml-10 rtl:mr-10" data-v-f0e467b4><!--[-->`);
      ssrRenderList(_ctx.$page.props.services, (service) => {
        _push(`<div class="my-4 transition duration-150 ease-in-out select-none" data-v-f0e467b4>`);
        _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`<!--]--></div></div><div class="flex items-center p-5" data-v-f0e467b4><div data-v-f0e467b4><div class="" data-v-f0e467b4>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("blogs"),
        class: "text-right"
      }, {
      ...
      _push(`</div></div></div><div class="flex items-center p-5" data-v-f0e467b4><div data-v-f0e467b4><div class="" data-v-f0e467b4>`);
      _push(ssrRenderComponent(unref(Link), {
        href: _ctx.route("projects"),
        class: "text-right"
      }, {
      ...
      _push(`</div></div></div><div class="flex p-5 space-x-6 rtl:space-x-reverse" data-v-f0e467b4><img src="/storage/images/facebook-ham.svg" class="w-5 h-5" alt="" data-v-f0e467b4><img src="/storage/images/instagram-ham.svg" class="w-5 h-5" alt="" data-v-f0e467b4><img src="/storage/images/twitter-ham.svg" class="w-5 h-5" alt="" data-v-f0e467b4></div></div></div></nav></div>`);
    };
  }
};
...
const NavBar = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f0e467b4"]]);
export {
  NavBar as N,
  _sfc_main$1 as _,
  _sfc_main$5 as a
