...
const FaqItem_vue_vue_type_style_index_0_scoped_43006981_lang = "";
const _sfc_main$1 = {
  __name: "FaqItem",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex items-center justify-center mt-10" }, _attrs))} data-v-43006981><div class="container max-w-4xl px-4 mx-auto md:px-0" data-v-43006981>`);
      if (!opened.value) {
        _push(`<div class="flex items-center h-16 px-8 space-x-2 border rounded-lg shadow-md cursor-pointer lg:h-16 rtl:space-x-reverse" data-v-43006981><img class="w-4 h-4 mx-2" loading="lazy" src="/storage/images/down-arrow-faq.svg" alt="arrow-down" data-v-43006981><p class="text-base lg:text-lg md:text-base text-secondarydark-600" data-v-43006981>${ssrInterpolate(__props.faq.question)}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (opened.value) {
        _push(`<div data-v-43006981><div class="flex cursor-pointer items-center lg:h-16 h-[3.8rem] md:h-20 border-t border-rose-900 border-r border-l rounded-t-lg bg-rose-900 px-5 lg:px-8 space-x-3 rtl:space-x-reverse" data-v-43006981><img class="w-4 h-4 mx-2" loading="lazy" src="/storage/images/down-arrow-faq-white.svg" alt="arrow-down" data-v-43006981><p class="text-base text-gray-50 lg:text-lg md:text-base" data-v-43006981>${ssrInterpolate(__props.faq.question)}</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (opened.value) {
        _push(`<div class="px-5 border-b border-l border-r rounded-b-lg border-rose-900 py-7 md:px-8 md:py-8" data-v-43006981><p class="text-sm font-medium lg:text-base" data-v-43006981>${ssrInterpolate(__props.faq.answer)}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
const FaqItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-43006981"]]);
const _sfc_main = {
  __name: "Index",
  __ssrInlineRender: true,
  props: {
