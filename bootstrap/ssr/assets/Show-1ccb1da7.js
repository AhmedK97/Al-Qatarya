import { useSSRContext, unref, mergeProps, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, ref, toDisplayString, createTextVNode, createCommentVNode } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass } from "vue/server-renderer";
import { _ as _sfc_main$2 } from "./AppLayout-b613aaf0.js";
import "@inertiajs/vue3";
import { Carousel, Navigation, Pagination, Slide } from "vue3-carousel";
/* empty css                   */import { S as SectionTitleShadow } from "./SectionTitleShadow-06c932f1.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(SectionTitleShadow, null, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("project.desc"))}`);
                } else {
                  return [
            ...
            _push2(`<div class="mt-10 text-lg font-medium text-gray-500"${_scopeId}>${__props.project.description}</div></div></header></div></div></article></div><ul class="flex m-5 space-x-2 md:w-2/5 md:m-auto"${_scopeId}><li class="flex-auto p-1 text-center"${_scopeId}><a class="${ssrRenderClass([{
            ...
            if (openTab.value === 1) {
              ...
              ssrRenderList(__props.project.images, (image) => {
                _push2(`<div class="w-full p-2 sm:w-1/2 lg:w-1/3"${_scopeId}><img class="w-64 h-56 m-auto rounded-lg" width="320" height="240"${ssrRenderAttr("src", image)} alt=""${_scopeId}></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (openTab.value === 2) {
              ...
              ssrRenderList(__props.project.videos, (video) => {
                _push2(`<div class="w-full p-2 sm:w-1/2 lg:w-1/3"${_scopeId}><video class="h-72" width="320" height="240" controls${_scopeId}><source${ssrRenderAttr("src", video)} type="video/mp4"${_scopeId}><source${ssrRenderAttr("src", video)} type="video/ogg"${_scopeId}> Your browser does not support the video tag. </video></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
              ...
              createVNode("main", { class: "pt-8 pb-16 bg-white lg:pt-16 lg:pb-24 dark:bg-gray-900" }, [
                createVNode("div", { class: "flex justify-between max-w-screen-xl px-4 mx-auto" }, [
                  createVNode("article", { class: "px-4 mx-auto w-100" }, [
                    createVNode("div", { class: "flex flex-col justify-between lg:flex-row lg:space-x-40 rtl:space-x-reverse" }, [
                      createVNode("div", { class: "m-5 space-y-10 text-center md:w-96" }, [
                  ...
                  createVNode("div", { class: "flex flex-wrap rtl:space-x-reverse" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.project.images, (image) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("img", {
                          class: "w-64 h-56 m-auto rounded-lg",
                          width: "320",
                          height: "240",
                          src: image,
                          alt: ""
