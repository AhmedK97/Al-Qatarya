...
import { mdiCashMultiple, mdiDomain, mdiPlus } from "@mdi/js";
import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3 } from "./LayoutAuthenticated-d69f9158.js";
import _sfc_main$7 from "./TransactionsTable-587794bf.js";
...
import "./TransactionsForm-93dd3fb4.js";
import "lodash/cloneDeep.js";
import "./FormField-9bc258f4.js";
import "./SelectField-fffe6a40.js";
import "laravel-vue-i18n";
import "vue-select";
import "./AddMoreTransactionsForm-694dbade.js";
import "./TransactionsPayment-170cc771.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "List Transaction" }, null, _parent2, _scopeId));
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    ...
                    number: __props.transactionsCount,
                    label: "Transactions",
                    color: "text-blue-500"
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_sfc_main$5, {
                          onClick: () => unref(eventBus).$emit("openModal", "transaction::create"),
                          color: "info",
                          icon: unref(mdiPlus),
                          label: "Add",
                          small: ""
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode(_sfc_main$7, {
                            ...
                            services: __props.services,
                            transactions: __props.transactions
                          }, null, 8, ["projects", "filters", "customers", "employees", "services", "transactions"])
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(unref(Head), { title: "List Transaction" }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Transactions/Index.vue");
