      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Dashboard" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.service.images, (imageUrl, index) => {
              _push2(`<div${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("service", __props.service.slug)
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative"${_scopeId2}><div class=""${_scopeId2}><img class="w-full rounded-lg h-96" loading="lazy"${ssrRenderAttr("src", imageUrl)}${ssrRenderAttr("alt", `Image ${index + 1}`)}${_scopeId2}></div><div class="absolute top-0 right-0 z-40 p-5 m-5 transition duration-300 ease-in-out bg-gray-100 rounded-lg shadow-lg hover:translate-y-2/3 h-80 shadow-blue-100 hover:shadow-rose-50 translate-y-3/4"${_scopeId2}><p class="text-xl font-bold text-rose-900"${_scopeId2}>${ssrInterpolate(__props.service.name)}</p><p class="mt-4 text-lg"${_scopeId2}>${ssrInterpolate(__props.service.body)}</p></div></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "relative" }, [
                        ...
                        createVNode("div", { class: "absolute top-0 right-0 z-40 p-5 m-5 transition duration-300 ease-in-out bg-gray-100 rounded-lg shadow-lg hover:translate-y-2/3 h-80 shadow-blue-100 hover:shadow-rose-50 translate-y-3/4" }, [
                          createVNode("p", { class: "text-xl font-bold text-rose-900" }, toDisplayString(__props.service.name), 1),
                          createVNode("p", { class: "mt-4 text-lg" }, toDisplayString(__props.service.body), 1)
                        ])
                      ])
                    ];
                  }
              ...
              createVNode("section", { class: "text-gray-600 body-font" }, [
                createVNode("div", { class: "container flex flex-col items-center justify-center mx-auto max-w-7xl" }, [
                  ...
                  createVNode("div", { class: "container grid grid-cols-1 px-4 mx-auto mt-10 md:grid-cols-2 lg:grid-cols-3 gap-x-10 max-w-7xl gap-y-60 mb-60" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.service.images, (imageUrl, index) => {
