...
import { _ as _sfc_main$b } from "./AppLayout-5766592f.js";
...
import Slider from "./Slider-76e9e936.js";
...
const BannerSlider = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-9319a1d8"]]);
const _sfc_main$9 = {
  __name: "WhyUs",
...
const Counter = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$7 = {
  __name: "WhoWeAre",
  __ssrInlineRender: true,
  setup(__props) {
...
const PartnerSlider = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main$5 = {
  __name: "HomeProjects",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(SectionTitleShadow, null, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="!text-secondary-700 !no-underline"${_scopeId}>${ssrInterpolate(_ctx.$t("projects"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "!text-secondary-700 !no-underline" }, toDisplayString(_ctx.$t("projects")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<hr class="w-32 h-1 mt-3 border-0 rounded rtl:w-40 bg-secondary-700"><p class="mt-4 text-lg font-medium text-gray-50">${ssrInterpolate(_ctx.$t("projects-desc"))}</p><div class="grid gap-6 mt-20 sm:grid-rows-3 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2"><!--[-->`);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(SectionTitleShadow, null, {
        "upper-title": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="!text-secondary-700 text-3xl lg:text-4xl"${_scopeId}>${ssrInterpolate(_ctx.$t("planning-upper"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "!text-secondary-700 text-3xl lg:text-4xl" }, toDisplayString(_ctx.$t("planning-upper")), 1)
            ];
          }
        }),
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="!text-secondary-700 text-xl md:text-4xl"${_scopeId}>${ssrInterpolate(_ctx.$t("planning"))}</span>`);
          } else {
            return [
              createVNode("span", { class: "!text-secondary-700 text-xl md:text-4xl" }, toDisplayString(_ctx.$t("planning")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<hr class="h-1 border-0 rounded md:w-48 bg-secondary-700"><p class="mt-4 font-medium md:text-lg ltr:lg:pl-0 ltr:lg:pr-20 rtl:lg:pl-20 rtl:lg:pr-0 text-gray-50">${ssrInterpolate(_ctx.$t("planning-desc"))}</p></div></div>`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/" + _ctx.$page.props.locale[0].currentLocaleCode + "/contact-us"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-center w-32 h-16 mb-8 text-xl text-white rounded-full lg:mb-0 bg-secondary-900 hover:bg-secondary-800"${_scopeId}>${ssrInterpolate(_ctx.$t("home.call_us"))}</div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center justify-center w-32 h-16 mb-8 text-xl text-white rounded-full lg:mb-0 bg-secondary-900 hover:bg-secondary-800" }, toDisplayString(_ctx.$t("home.call_us")), 1)
            ];
          }
        }),
        _: 1
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.services, (service) => {
        _push(`<div class="flex space-x-2 rtl:space-x-reverse"><div class="flex items-center justify-center w-6 h-6 rounded-full xl:w-8 xl:h-8 bg-rose-900 shrink-0"><img src="/storage/images/check-white.svg" class="w-3 xl:w-5" loading="lazy" alt=""></div>`);
        _push(ssrRenderComponent(unref(Link), {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))}><div class="px-6 mx-auto mt-5 text-3xl max-w-7xl lg:px-8">`);
      _push(ssrRenderComponent(SectionTitleShadow, null, {
        "upper-title": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("services-upper"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("services-upper")), 1)
            ];
          }
        }),
        title: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<p class="text-xl font-semibold leading-snug my-7">${ssrInterpolate(_ctx.$t("services-desc"))}</p>`);
      _push(ssrRenderComponent(Slider, { services: __props.services }, null, _parent));
      _push(`</div></section>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const openTab = ref(1);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container px-4 mx-auto max-w-7xl" }, _attrs))}><ul class="flex flex-row flex-wrap pt-3 pb-4 mb-0 space-x-2 list-none rtl:space-x-reverse"><li class="flex-auto text-center"><a class="${ssrRenderClass([{
        "text-rose-900 bg-white": openTab.value !== 1,
        "text-secondary-700 bg-rose-900": openTab.value === 1
        ...
        "text-rose-900 bg-white": openTab.value !== 2,
        "text-secondary-700 bg-rose-900": openTab.value === 2
      ...
      _push(ssrRenderComponent(_sfc_main$3, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("services.insulation"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("services.insulation")), 1)
            ];
          }
        }),
        _: 1
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$b, mergeProps({ title: "القطرىة" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$9, { class: "mt-20 md:mt-40" }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$7, { class: "mt-20 md:mt-40" }, null, _parent2, _scopeId));
            ...
            return [
              ...
              createVNode(_sfc_main$9, { class: "mt-20 md:mt-40" }),
              createVNode(_sfc_main$7, { class: "mt-20 md:mt-40" }),
