<template>
    <div class="flex items-center justify-center sm:hidden">
        <div
            class="fixed z-50 flex items-center justify-between px-4 border rounded-full bottom-4 bg-rose-900 border-gray-50">
            <Link :href="route('home')">
            <div class="flex flex-col items-center justify-center px-3 py-2 space-y-1 hover:bg-rose-800">
                <img src="/storage/images/mobile-controllers-house.svg" alt="WhatsApp" class="w-6 h-6" />
            ...
            <div class="relative flex flex-col items-center justify-center px-3 py-2 space-y-1 hover:bg-rose-800"
            ...
            <div class="absolute left-28 bottom-20" v-show="showingNavigationDropdown">
                <div class="p-4 space-y-4 border-2 rounded-lg border-rose-900 bg-gray-50">
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        <a href="tel:+123456789" class="">
                            <div class="flex">

                                <img src="/storage/images/phone-white.svg" alt="Call Us"
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        <a href="https://wa.me/123456789" target="_blank">
                            <div class="flex">
                                <img src="/storage/images/whatsapp-white.svg" alt="WhatsApp"
            ...
            <div class="flex flex-col items-center justify-center px-3 py-2 space-y-1 hover:bg-rose-800">
                <img src="/storage/images/mobile-controllers-services.svg" alt="WhatsApp" class="w-6 h-6" />
                <p class="text-gray-50 whitespace-nowrap">
