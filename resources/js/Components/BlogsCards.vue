    ...
    <section class="bg-red-50 ">
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto mb-8 text-center lg:mb-16">
                <p class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 lg:text-4xl">
                    <span
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <article v-for="(blog, index) in blogs.data" :key="index"
                    ...
                    <div class="flex items-center justify-between mb-5 text-gray-500">
                        <!-- image -->
                        <img class="object-fill w-full h-[15rem]"  loading="lazy" :src="blog.image"
                            alt="Alexandra avatar" />
                    </div>

                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-center text-gray-900">
                    ...
                    <p class="mb-5 font-semibold text-center text-gray-500 ">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <Link :href="route('show.blogs', blog.slug)"
                            class="inline-flex items-center font-medium text-primary-600 hover:underline">
                        اقرأ المزيد
                        <svg class="w-4 h-4 mt-1 ml-2" fill="currentColor" viewBox="0 0 20 20"
