...
<template>
    <CardBox form @submit.prevent="submit">
        ...
        <div v-if="isUpdate">
            ...
            <v-select :options="customers" label="name" v-model="form.customer_id" :reduce="option => option.id"></v-select>
            ...
            <v-select :options="employees" label="name" v-model="form.employee_id" :reduce="option => option.id"></v-select>
